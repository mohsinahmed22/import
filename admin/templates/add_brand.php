...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add New Brands <small>will be added to front end automatically</small></h2>
...
<!--                                <input type="text" name="brandname" required="required" class="form-control col-md-7 col-xs-12">-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="brandurl" required="required" class="form-control col-md-7 col-xs-12">
