                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter Currency Symbol"
                                           name="store_default_cur" required>
                                        <small>Default Currency is "PKR"</small>
                                </div>

                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Default Currency Symbol <span
                                        class="required">*</span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter Currency Symbol"
                                           name="store_default_cur_symbol" required>
                                    <small>Default Currency Symbol is "Rs."</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Conversion Currency <span
                                        class="required">*</span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter  Conversion  Currency"
                                           name="store_default_cur" required>
                                    <small>Default Conversion Currency is "USD"</small>
                                </div>

                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Conversion Currency Symbol <span
                                        class="required">*</span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter Conversion Currency Symbol"
                                           name="store_default_cur_symbol" required>
                                    <small>Default Conversion Currency Symbol is "$"</small>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
